 ...
 */
class GoodSearchController extends \ItForFree\SimpleMVC\mvc\Controller
{
...
//                die();
            if ($searchGood){
                ...
                $this->header(\ItForFree\SimpleMVC\Url::link('goodSearch/index&total=ничего не найдено'));
            }
        } 
