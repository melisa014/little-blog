...
<h2><?php echo $addArticleTitle ?></h2>

<form method="post" action="/index.php?action=article/add"> <!--&id=<?php echo $_GET['id']; ?>-->
    <h5>Введите название статьи</h5>
    <input type="text" name="title" value="*название статьи*"><br>
    <h5>Выберите категорию статьи</h5>
    <input type="text" name="categoryId" value="*категория*"><br>
